...
function startGame() {
  ...
  // $("#wordToGuess").html(blanksAndLetters.join(" "));
   ...
   lossCount++;
    ...
    function roundComplete() {
      ...
      if(lettersInWord.toString() == blanksAndLetters.toString()) {
        ...
        // $("#winCount").html(winCount);
        // $("#resultImage").html('<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTT-TSCo9_xJm9ainCPgOm0j0eu-35WQTUZI8rawEmDvfBWM6TZA" />';
        startGame();
      }
        ...
        // $("#lossCount").html(lossCount);
        // $("#resultImage").html('<img src="data:image/jpeg;base64," />';
        startGame();
      }
    }
